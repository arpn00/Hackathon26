# KM Search
Knowledge Management (KM) Search experiments are very much like [Commercial Case Search](Commercial-Case-Search.md) experiments but as the name suggests, uses KM Articles rather than Commercial Cases.  
  
![KM Search](/wiki/imgs/KM-Search.png)  
  
# Search Capabilities
The ZebraAI KM search allows you to enter a search term in the available text field to guide your search.  
...
@{Collection}, @{Content}, @{ContentRaw}, @{Domain}, @{Source}, @{SourceId}, @{TItle}, @{Url}
