# Commercial Case and Related KM content Search 
**Commercial Case + KM Content Search** experiments function like [Commercial Case Search](Commercial-Case-Search.md) experiments but allow the user to select both Commercial Cases as well as the Knowledge Management articles (KMs) related to those selected cases and use all the selected data in their experiments.  

 ![Comm+KM](/wiki/imgs/Commercial-KM.png)  

# Using this Experience
To effectively use the **Commercial Case + KM Content Search** experiment type, complete the following:  
- **Step 1: Select Commercial Cases** You must first search and select the cases to be included in your experiment.  This functions in a limited way as compared to the [Commercial Case Search](Commercial-Case-Search.md).  Many of the filters available in Commercial Case Search are not available here. You can however use the available text search to find cases of interest. Once your cases are selected you can then move to Step 2.
- **Step 2: Select Related KMs** A list of KMs is automatically presented once case search results are displayed, see below. This list of KMs is sorted by search score.  You can then select the KMs to be included in your experiment and proceed to run your experiment.  

![Comm+KM](/wiki/imgs/Commercial-KM-Results.png)  

# Available Data references
Commercial Case data can be referenced through the following data table reference in youur prompts:  
